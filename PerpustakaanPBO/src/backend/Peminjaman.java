...
public class Peminjaman {
    ...
    public Peminjaman() {
        this.anggota = new Anggota(); // Pastikan selalu terinisialisasi
        this.buku = new Buku();   
    }
    ...
    public Peminjaman getById(int id) {
        ...
        try {
            while (rs.next()) {
                ...
                // Inisialisasi objek jika null
                if (peminjaman.getAnggota() == null) {
                    peminjaman.setAnggota(new Anggota());
                }
