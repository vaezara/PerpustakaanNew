...
public class FrmPegawai extends javax.swing.JFrame {
    ...
    public void cari(String keyword) {
        ...
        for (Pegawai pgw : list) {
            rowData[0] = pgw.getIdpegawai();  // ID Pegawai
            rowData[1] = pgw.getNama();       // Nama
            rowData[2] = pgw.getAlamat();     // Alamat
            rowData[3] = pgw.getNotelp();     // Telepon
            rowData[4] = pgw.getJabatan();    // Jabatan
            rowData[5] = pgw.getUsername();   // Username
            rowData[6] = pgw.getPassword();   // Password
    ...
    private void btnCekuserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCekuserActionPerformed
        ...
        // Validasi awal: cek apakah field username kosong
        if (username.isEmpty()) {
            javax.swing.JOptionPane.showMessageDialog(this, 
                "Username tidak boleh kosong. Silakan masukkan username.", 
                "Peringatan", 
        ...
        boolean usernameExists = pegawai.isUsernameExists(username);
        ...
        if (usernameExists) {
            ...
            javax.swing.JOptionPane.showMessageDialog(this, 
                "Username tersedia! Anda dapat menggunakannya.", 
                "Informasi", 
